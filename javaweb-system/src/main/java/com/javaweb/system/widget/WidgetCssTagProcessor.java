...
public class WidgetCssTagProcessor extends AbstractAttributeTagProcessor {
    /**
     * 属性名
     */
    private static final String ATTR_NAME = "css";
    /**
     * 元素名
     */
    private static final String ELE_NAME = "link";
    /**
     * 优先级
     */
     ...
     */
    public WidgetCssTagProcessor(String dialectPrefix) {
        super(
                // 此处理器将仅应用于HTML模式
                TemplateMode.HTML,
                // 要应用于名称的匹配前缀
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag, AttributeName attributeName, String s, IElementTagStructureHandler iElementTagStructureHandler) {
        ...
        iElementTagStructureHandler.setAttribute("href", url);
    }
}
