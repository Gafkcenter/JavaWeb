package com.javaweb.system.widget.iconpicker;
...
public class WidgetIconPickerTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag, IElementTagStructureHandler iElementTagStructureHandler) {
        ...
        model.add(modelFactory.createOpenElementTag(String.format("input type=\"hidden\" id=\"%s\" name=\"%s\" lay-filter=\"%s\" value=\"%s\"", tagName, tagName, tagName, tagValue)));
