...
public class WidgetBtnDetailTagProcessor extends AbstractElementTagProcessor {
    /**
     * 标签名
     */
    private static final String TAG_NAME = "btnDetail";
    /**
     * 优先级
     */
     ...
     */
    public WidgetBtnDetailTagProcessor(String dialectPrefix) {
        super(
                // 此处理器将仅应用于HTML模式
                TemplateMode.HTML,
                // 要应用于名称的匹配前缀
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag, IElementTagStructureHandler iElementTagStructureHandler) {
        ...
        // 这里是将字典的内容拼装成一个下拉框
        model.add(modelFactory.createOpenElementTag("a class=\"layui-btn layui-bg-black layui-btn-xs\" lay-event=\"detail\""));
